...
type AuthClient interface {
	...
	GetRole(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*RoleResponse, error)
...
func (c *authClient) GetRole(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*RoleResponse, error) {
...
type AuthServer interface {
	...
	// GetRole returns the role of a user.
	GetRole(context.Context, *UserIdRequest) (*RoleResponse, error)
	// Logout logs out a user.
...
func (UnimplementedAuthServer) GetRole(context.Context, *UserIdRequest) (*RoleResponse, error) {
...
func _Auth_GetRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).GetRole(ctx, req.(*UserIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
